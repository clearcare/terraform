...
func resourceAwsElasticacheReplicationGroupRedisCluster() *schema.Resource {
	...
	resourceSchema["endpoint_address"] = &schema.Schema{
	...
	return &schema.Resource{
		Create: resourceAwsElasticacheReplicationGroupRedisClusterCreate,
...
func resourceAwsElasticacheReplicationGroupRedisClusterCreate(d *schema.ResourceData, meta interface{}) error {
